...
def arguments_nbr(input):
    '''Function that takes a string as input and returns number of words
    in this string.'''
    num = 0
    for word in input:
        num += 1
...
def upper_letters_counter(input):
    '''Function that counts and returns number of Upper Letters in the
    provided string'''
...
def lower_letters_counter(input):
    '''Function that counts and returns number of Lower Letters in the
    provided string'''
...
def punctuation_marks_counter(input):
    '''Function that counts and returns number of Punctuation Marks in
    the provided string'''
    punct_marks = "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~"
    counter = 0
    for char in input:
...
def spaces_counter(input):
    '''Function that counts and returns number of spaces in the
    provided string'''
    space = " "
    counter = 0
    for char in input:
...
def digits_counter(input):
    '''Function that counts and returns number of digits in
    the provided string'''
    digits = "0123456789"
    counter = 0
    for char in input:
...
def display_results(input):
    '''Function that counts all the characters and prints the
    total amount and number of characters of each type separately
...
def main():
    '''Main function that handles exceptions and all the tests,
