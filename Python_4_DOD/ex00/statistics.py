...
def ft_statistics(*args: tp.Any, **kwargs: tp.Any) -> None:
    '''Function that processes data sequence and prints
    median, mean, quartile, std, var'''
    if not args:
        ...
        for value in dct.values():
            if value.lower() == "mean":
                ...
                print(f"quartile: [{float(left_half[q25_ind])}, ", end='')
                print(f"{float(right_half[q75_ind])}]")
